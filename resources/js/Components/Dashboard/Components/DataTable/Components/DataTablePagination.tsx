...
export function DataTablePagination<TData>({
  ...
  return (
    <div className="flex flex-col md:flex-row w-full gap-2 md:gap-0 items-center justify-between">
      <div className="md:flex-1 text-xs md:text-sm text-muted-foreground">
        {table.getFilteredSelectedRowModel().rows.length} /{" "}
        {table.getFilteredRowModel().rows.length} baris terpilih.
      </div>
      <div className="flex flex-col md:flex-row gap-2 md:gap-0 items-center space-x-6 lg:space-x-8">
        <div className="flex items-center space-x-2">
          <p className="text-xs md:text-sm font-medium">Baris/halaman</p>
          <Select
